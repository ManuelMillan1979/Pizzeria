    ...
    <div className="home xs:h-[167vh] 2xl:h-full">
      <div className="h-[303px] 2xl:h-[51vh] flex justify-center items-end mb-10">
        ...
        >
          ...
          />
          <img
            className="absolute xs:h-[13vh] ml-[8rem] mt-[-1rem] sm:w-[108px] md:ml-[128px] lg:ml-[141px] xl:ml-[141px] 2xl:ml-[245px] 2xl:w-[10vw] 2xl:mt-[21px]"
            src={currentImage}
            alt=""
          />
        </div>
      ...
      <div className="xs:h-[100vh] flex flex-wrap mt-[7rem] sm:justify-center 2xl:h-[26vh]">
        <div className="rectangle11 xs:w-[57%] h-[10rem] sm:mr-2 2xl:w-[13%] flex justify-center flex-col">
          <Link to="/TarjetasPizzas">
            <img
              className="relative xs:w-[38vw] ml-[43px] mb-[61px] mt-[-49px] sm:w-[105px] 2xl:w-[8vw]"
              src={remolo1}
              alt=""
            />
        ...
        <div className="rectangle11 xs:w-[57%] h-[10rem] sm:mr-2 2xl:w-[13%] flex justify-center flex-col">
          <Link to="/TarjetasEmpanadas">
            <img
              className="relative xs:w-[38vw] ml-[43px] mb-[61px] mt-[-49px] sm:w-[105px] 2xl:w-[10vw]"
              src={empanadas}
              alt=""
            />
            <p className="relative h-[77px] mt-[-67px] flex justify-center items-center font-courgette text-[15px] 2xl:text-[30px]">
        ...
        <div className="rectangle11 xs:w-[57%] h-[10rem] sm:mr-2 2xl:w-[13%] flex justify-center flex-col">
          <Link to="/TarjetasBebidas">
            <img
              className="relative xs:w-[15vw] ml-[88px] mb-[61px] mt-[-67px] sm:w-[49px] 2xl:w-[3.4vw]"
              src={gaseosas}
              alt=""
            />
            <p className="relative h-[77px] mt-[-67px] flex justify-center items-center font-courgette text-[15px] 2xl:text-[30px]">
