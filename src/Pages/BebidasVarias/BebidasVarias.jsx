...
const BebidasVarias = ({ productoSeleccionado, agregarAlCarrito }) => {
  return (
    ...
    <div key={productoSeleccionado.id} className="home flex flex-col justify-center h-screen ">
      ...
      <div className="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-10 max-w-xs md:max-w-3xl mx-auto ">
        <div className="w-full md:w-1/3 md:h-[19rem]  ml-[-76px]  overflow-hidden">
          <img
